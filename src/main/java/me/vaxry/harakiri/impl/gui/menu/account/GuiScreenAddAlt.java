...
public class GuiScreenAddAlt extends GuiScreen {
    ...
    private final Account serverData;
    ...
    public GuiScreenAddAlt(GuiScreen parentScreenIn, Account serverDataIn) {
    ...
    public void initGui() {
        ...
        //this.serverResourcePacks = this.addButton(new GuiButton(2, this.width / 2 - 100, this.height / 4 + 72, I18n.format("addServer.resourcePack", new Object[0]) + ": " + this.serverData.getResourceMode().getMotd().getFormattedText()));
        this.serverNameField = new GuiTextField(0, this.fontRenderer, this.width / 2 - 100, 66, 200, 20);
        this.serverNameField.setFocused(true);
        this.serverNameField.setText(this.serverData.email);
        ...
        this.serverIPField.setText(this.serverData.pass);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 2) {
                ...
                this.serverData.email = this.serverNameField.getText();
                this.serverData.pass = this.serverIPField.getText();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(this.fontRenderer, "Email", this.width / 2 - 100, 53, 10526880);
