...
public final class ModuleSearchComponent extends ResizableHudComponent {
   ...
   //private ModuleSettingsComponent currentSettings;
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        // its border
        RenderUtil.drawLine(this.getX() + BORDER, this.getY() + offsetY + BORDER, this.getX() + BORDER + this.getW() - SCROLL_WIDTH, this.getY() + offsetY + BORDER, 1.f, this.isTypingEnabled ? this.useRainbow ? rainbowCol : ACCENT_COLOR : 0x99444444);
        ...
        RenderUtil.drawLine(this.getX() + BORDER, this.getY() + offsetY + BORDER + Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT + 2, this.getX() + BORDER + this.getW() - SCROLL_WIDTH, this.getY() + offsetY + BORDER + Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT + 2, 1.f, this.isTypingEnabled ? this.useRainbow ? rainbowCol : ACCENT_COLOR : 0x99444444);
        RenderUtil.drawLine(this.getX() + BORDER + this.getW() - SCROLL_WIDTH, this.getY() + offsetY + BORDER + Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT + 2, this.getX() + BORDER + this.getW() - SCROLL_WIDTH, this.getY() + offsetY + BORDER, 1.f, this.isTypingEnabled ? this.useRainbow ? rainbowCol : ACCENT_COLOR : 0x99444444);
        ...
        offsetY += Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT + TEXT_GAP + 2; // Fix offset

        this.title = this.originalName;
        for (Module module : Harakiri.INSTANCE.getModuleManager().getModuleList()) {
           ...
           //     RenderUtil.drawRect(this.getX() + BORDER + TEXT_GAP, this.getY() + offsetY + BORDER + TEXT_GAP - this.scroll, this.getX() + BORDER + TEXT_GAP + this.getW() - BORDER - SCROLL_WIDTH - BORDER - 2, this.getY() + offsetY + BORDER + TEXT_GAP + Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT - this.scroll, module.isEnabled() ? rainbowColBG : 0x451F1C22);
            ...
            if(useRainbow)
                Harakiri.INSTANCE.getTTFFontUtil().drawStringWithShadow(module.getDisplayName(), this.getX() + BORDER + TEXT_GAP + 1, this.getY() + offsetY + BORDER + TEXT_GAP - this.scroll, module.isEnabled() ? rainbowCol : 0xFFAAAAB7);
            else
                Harakiri.INSTANCE.getTTFFontUtil().drawStringWithShadow(module.getDisplayName(), this.getX() + BORDER + TEXT_GAP + 1, this.getY() + offsetY + BORDER + TEXT_GAP - this.scroll, module.isEnabled() ? ACCENT_COLOR : 0xFFAAAAB7);
    ...
    public void mouseRelease(int mouseX, int mouseY, int button) {
        ...
        if (inside && !insideTitlebar && !isResizeDragging()) {
            ...
            if(mouseX >= (this.getX() + BORDER) * SCALING && mouseX <= (this.getX() + this.getW() - BORDER - SCROLL_WIDTH - 1) * SCALING &&
                    mouseY >= this.getY() + BORDER + titleBarHeight - this.scroll && mouseY <= this.getY() + BORDER + titleBarHeight + Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT + 2 - this.scroll){
                // Inside the textbox
            ...
            offsetY += Harakiri.INSTANCE.getTTFFontUtil().FONT_HEIGHT + 2;
