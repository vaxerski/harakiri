...
import me.vaxry.harakiri.api.gui.hud.component.ToolTipComponent;
    ...
    public static class TrayButtonComponent extends HudComponent {
        ...
        public void onDisplayGui(EventDisplayGui event) {
            if (event.getScreen() instanceof GuiHudEditor) {
                HudComponent component = Harakiri.INSTANCE.getHudManager().findComponent(this.getName()); // find our component from the name
                if (component != null) {
        ...
        public void mouseRelease(int mouseX, int mouseY, int button) {
            ...
            if (this.isMouseInside(mouseX, mouseY)) {
                HudComponent component = Harakiri.INSTANCE.getHudManager().findComponent(this.getName()); // find our clicked component
                if (component != null) {
