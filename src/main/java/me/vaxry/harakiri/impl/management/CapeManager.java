...
import me.vaxry.harakiri.api.cape.CapeUser;
            ...
            for (CapeUser user : this.capeUserList) {
                if (user != null) {
                    ...
                    if (cape == null) {
                        ...
                        final ResourceLocation location = Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("harakiri/capes", texture);
