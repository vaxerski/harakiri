...
import me.vaxry.harakiri.api.task.hand.HandSwapContext;
...
public final class AutoWitherModule extends Module {
    ...
    public final Value<Float> placeDelay = new Value<Float>("Delay", new String[]{"PlaceDelay", "PlaceDel"}, "The delay (in ms) between blocks being placed.", 100.0f, 0.0f, 500.0f, 1.0f);
    public final Value<Float> waitDelay = new Value<Float>("WaitDelay", new String[]{"RightClickDelay", "wd"}, "The delay (in ms) between withers being created on right click.", 750.0f, 0.0f, 1000.0f, 1.0f);
    ...
    public AutoWitherModule() {
        super("AutoWither", new String[]{"Wither+", "Wither", "Withers"}, "Automatically spawns withers.", "NONE", -1, ModuleType.WORLD);
    }
